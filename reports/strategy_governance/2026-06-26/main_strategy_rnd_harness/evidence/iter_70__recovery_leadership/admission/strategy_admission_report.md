...
- Strategy set: ``
- Strategies: `strong_benchmark_recovery_leadership_v1`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| strong_benchmark_recovery_leadership_v1 | reject | 0/1 | 0 | 0 | 0 | 1 | 0 | 0 | False | high | overfit risk is high; industry concentration exceeds audit threshold in one or more windows; strategy does not support paper trade review; positive fold ratio below 75% in one or more windows |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| strong_benchmark_recovery_leadership_v1 | baseline_2y_1y_5fold | ok | 5 | 2019-04-01~2026-03-31 | 5 | 5 |  | qfq_asof | -0.0044 | -0.2705 | -0.0704 | 1.17 | enabled:audited | 0.04 | 0.09 | not_enabled | n/a | n/a | n/a | False |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| strong_benchmark_recovery_leadership_v1 | baseline_2y_1y_5fold | available | 5 | -0.0278 | 0.0235 | -0.0931 | 0.40 | 0.60 | 3 | 3 | 0 | 0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| strong_benchmark_recovery_leadership_v1 | baseline_2y_1y_5fold | not_applicable | n/a | n/a | n/a | n/a | n/a | use:cash_flow_quality | not_applicable |
