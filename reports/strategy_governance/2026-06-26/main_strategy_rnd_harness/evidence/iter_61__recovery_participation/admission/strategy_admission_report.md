...
- Strategies: `strong_benchmark_recovery_participation_v1`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| strong_benchmark_recovery_participation_v1 | reject | 0/1 | 0 | 0 | 0 | 1 | 0 | 0 | False | high | overfit risk is high; industry concentration exceeds audit threshold in one or more windows; strategy does not support paper trade review; positive fold ratio below 75% in one or more windows |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| strong_benchmark_recovery_participation_v1 | baseline_2y_1y_5fold | ok | 5 | 2019-04-01~2026-03-31 | 5 | 5 |  | qfq_asof | -0.0099 | -0.3801 | -0.0780 | 1.86 | enabled:audited | 0.04 | 0.11 | not_enabled | n/a | n/a | n/a | False |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| strong_benchmark_recovery_participation_v1 | baseline_2y_1y_5fold | available | 5 | -0.0278 | 0.0179 | -0.0851 | 0.20 | 0.40 | 4 | 2 | 2 | 0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| strong_benchmark_recovery_participation_v1 | baseline_2y_1y_5fold | not_applicable | n/a | n/a | n/a | n/a | n/a | use:cash_flow_quality | not_applicable |
