...
Generated at: 2026-06-26T02:42:52

## Run Context

- Command: `phase0.cli strategy-admission --config config.main_strategy_i57_strong_benchmark_participation_boost_20260626.yaml --presets baseline_2y_1y_5fold --strategy-set i57_strong_benchmark_participation_boost_v1 --output-dir /home/zj/workspace/stok-mapping/reports/strategy_governance/2026-06-26/main_strategy_rnd_harness/evidence/iter_57__strong_benchmark_participation_boost/admission`
- Strategy scope source: `strategy_set`
- Strategy set: `i57_strong_benchmark_participation_boost_v1`
- Strategy set description: I57 scoped admission for research-only strong_benchmark_participation_boost_v1.
- Presets: `baseline_2y_1y_5fold`
- Strategies: `strong_benchmark_participation_boost_v1`
...
| --- | --- | --- | --- |
| strong_benchmark_participation_boost_v1 | reject | 0/1 | overfit risk is high; annual turnover exceeds threshold in one or more windows; industry concentration exceeds audit threshold in one or more windows; strategy does not support paper trade review; positive fold ratio below 75% in one or more windows |
