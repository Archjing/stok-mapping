...
| strong_market_benchmark_aware_core_v1 | baseline_2y_1y_5fold | 5 | 2025-04-01..2026-03-31 | relative_failure_benchmark_strong | medium | 0.0426 | 0.1511 | -0.1084 | 0.6283 | -0.0400 | 1.73 |
...
- Turnover status: `turnover_pass`
- Existing fold attribution: `positive_fold`
- Evidence: ann=0.0426 vs gate=0.0000；benchmark_ann=0.1511；excess_ann=-0.1084；sharpe=0.6283 vs gate=0.5000；max_drawdown=-0.0400 vs gate=-0.2500；turnover=1.73 vs gate=5.00
- Next diagnostic action: 优先解释为何绝对赚钱但跑输沪深300；不要用该 fold 直接调选股参数。
