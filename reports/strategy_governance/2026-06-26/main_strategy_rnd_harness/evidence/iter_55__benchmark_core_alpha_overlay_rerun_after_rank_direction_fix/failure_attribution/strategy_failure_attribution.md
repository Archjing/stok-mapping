...
- overfit: `/home/zj/workspace/stok-mapping/reports/strategy_governance/2026-06-26/main_strategy_rnd_harness/evidence/iter_55__benchmark_core_alpha_overlay_rerun_after_rank_direction_fix/admission/overfit_diagnostic/strategy_overfit_diagnostic.csv`

## 汇总

| strategy_id | preset | action | severity | primary_failure | return | execution | construction | factor | parameter | regime | data |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| benchmark_core_alpha_overlay_v1 | baseline_2y_1y_5fold | reject | 高 | 收益失败 | high | none | high | none | none | high | none |
...
- 证据：收益失败：年化收益均值 -0.0019 未通过 gate 0.0000；Sharpe 均值 -0.0999 未通过 gate 0.5000；正收益折比例 40.00% 未通过 gate 75.00% | 组合构造失败：行业集中度触发 admission 审计阈值：top1_mean=3.08%, top3_mean=7.34%, violation_days=1205 | 市场阶段失败：策略级 overfit_risk_level=high
