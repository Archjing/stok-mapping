...
Generated at: 2026-06-26T00:58:49

## Run Context

- Command: `phase0.cli strategy-admission --config config.main_strategy_i53_context_switch_rebalance_20260626.yaml --presets baseline_2y_1y_5fold --strategy-set i53_context_switch_rebalance_v1 --output-dir /home/zj/workspace/stok-mapping/reports/strategy_governance/2026-06-26/main_strategy_rnd_harness/evidence/iter_54__context_switch_rebalance_param_fix/admission`
- Strategy scope source: `strategy_set`
- Strategy set: `i53_context_switch_rebalance_v1`
- Strategy set description: I53 scoped admission for research-only strong_market_benchmark_aware_core_v1 with context-switch rebalancing.
...
| --- | --- | --- | --- |
| strong_market_benchmark_aware_core_v1 | reject | 0/1 | overfit risk is high; annual turnover exceeds threshold in one or more windows; industry concentration exceeds audit threshold in one or more windows; strategy does not support paper trade review; positive fold ratio below 75% in one or more windows |
