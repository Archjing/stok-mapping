...
- Command: `phase0.cli strategy-admission --config config.main_strategy_i54_context_switch_rebalance_param_fix_20260626.yaml --presets baseline_2y_1y_5fold --strategy-set i54_context_switch_rebalance_param_fix_v1 --output-dir /home/zj/workspace/stok-mapping/reports/strategy_governance/2026-06-26/main_strategy_rnd_harness/evidence/iter_54__context_switch_rebalance_param_fix_rerun_after_context_default_fix/admission`
- Strategy scope source: `strategy_set`
- Strategy set: `i54_context_switch_rebalance_param_fix_v1`
- Strategy set description: I54 scoped admission for research-only strong_market_benchmark_aware_core_v1 after rebalance_on_context_change parameter fix.
