...
Generated at: 2026-06-25T10:24:30
...
- Fold attribution: `/home/zj/workspace/stok-mapping/reports/strategy_governance/2026-06-25/main_strategy_rnd_harness/evidence/iter_35__strong_market_candidate_csi300_attribution/i20_failure_attribution/strategy_failure_fold_attribution.csv`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| baseline_2y_1y_5fold | 1 | absolute_failure_market_weak_but_outperform | absolute_loss_but_benchmark_weak_context | weak_down | mostly_below_trend | mostly_normal_vol | 0.1111 | 0.8971 | 0.0000 | -0.1796 | 0.1796 |
...
| baseline_2y_1y_5fold | 5 | relative_failure_benchmark_strong | relative_lag_in_strong_benchmark_context | strong_up | mostly_above_trend | mixed_vol | 0.7934 | 0.2934 | 0.0343 | 0.1511 | -0.1168 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| absolute_failure_market_weak_but_outperform | 3 | 0.1250 | -0.1144 | 0.2063 | 0.2407 | 0.8185 | absolute_loss_but_benchmark_weak_context |
| relative_failure_benchmark_strong | 1 | -0.1168 | 0.1512 | 0.7934 | 0.2025 | 0.2934 | relative_lag_in_strong_benchmark_context |
