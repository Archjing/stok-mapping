...
- Command: `phase0.cli strategy-admission --config config.main_strategy_i37_strong_market_effective_participation_20260625.yaml --presets baseline_2y_1y_5fold --strategies strong_market_effective_participation_v1 --output-dir /home/zj/workspace/stok-mapping/reports/strategy_governance/2026-06-25/main_strategy_rnd_harness/evidence/iter_37__strong_market_effective_participation/admission`
...
| --- | --- | --- | --- |
| strong_market_effective_participation_v1 | reject | 0/1 | overfit risk is high; annual turnover exceeds threshold in one or more windows; industry concentration exceeds audit threshold in one or more windows; strategy does not support paper trade review; positive fold ratio below 75% in one or more windows |
