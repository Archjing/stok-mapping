...
from phase0.local_history import configure_local_history, load_daily_from_local_history, local_history_path
...
def run_strategy_core_reachability_diagnostic(
    *,
    ...
    benchmark = benchmark_symbol or str(config.get("benchmark_symbol") or config.get("phase0", {}).get("benchmark_symbol") or "SH.000300")
