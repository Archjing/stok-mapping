...
from phase0.execution.accounts import build_account_ledger, load_simulated_accounts
from phase0.reporting.exports import export_brief_account_bill, export_phase0_premarket
from phase0.reporting.paths import latest_dir, slug
...
def run_watchlist_pipeline(
    *,
    ...
    for selected_account_id in selected_account_ids:
        ...
        result = export_phase0_premarket(**premarket_kwargs)
