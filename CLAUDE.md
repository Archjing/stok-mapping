...
- Before creating or modifying a worktree, read [`WORKTREE_PROTOCOL.md`](WORKTREE_PROTOCOL.md) for path permissions, research-worktree boundaries, and the promotion/synchronization workflow.
