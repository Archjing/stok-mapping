...
from quant.data_access.connectivity import fetch_cn_daily, fetch_hk_daily, fetch_yf_daily
...
from quant.data_access.local_history import (
...
from quant.research.metrics import (
...
from quant.universe import load_point_in_time_universe, load_universe_symbols
...
def _fold_panel_cache_key(
    *,
    ...
    return _stable_hash(
        {
            "version": 2,
            "namespace_version": CACHE_NAMESPACE_VERSION,
