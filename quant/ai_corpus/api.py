...
from quant.ai_corpus.providers.cctv_news import fetch_cctv_news
from quant.ai_corpus.providers.cninfo import fetch_cninfo_announcements
...
from quant.ai_corpus.storage import query_ai_corpus_documents
...
def fetch_ai_corpus(
    *,
    ...
    if canonical == "semi_supply_chain":
        from quant.ai_corpus.providers.semi_supply_chain import (
