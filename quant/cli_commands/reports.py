...
from quant.reporting.exports import (
    export_execution_gate,
    export_financial_pti,
...
def handle_report_export_command(args: argparse.Namespace, *, parser: argparse.ArgumentParser, console: Any | None = None) -> int:
    ...
    if args.cmd == "financial-pti":
        ...
        result = export_financial_pti(config_path)
    ...
    if args.cmd == "universe-pti":
        ...
        result = export_universe_pit(config_path, as_of_date=str(args.date))
