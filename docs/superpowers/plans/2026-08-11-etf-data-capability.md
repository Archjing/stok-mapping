...
- The implementation stores data in `data/etf_history.sqlite`, not in `data/a_share_history.sqlite`.
...
| `data/README.md` | Document ETF data semantics, commands, resume rules, and local-only assets. |
...
Add an ETF section to `data/README.md` containing:
...
```bash
git add phase0/data_governance/etf_audit.py phase0/cli_commands/data_update.py phase0/cli.py data/README.md tests/test_etf_audit.py tests/test_cli_data_update_commands.py
...
```bash
git add phase0 config.yaml data/README.md tests docs/superpowers/plans/2026-08-11-etf-data-capability.md
