...
| `intelligence` | Strategy intelligence collection, import, validation, review, external signal/probe scripts | `phase0/intelligence/__init__.py`, `phase0/intelligence/schema.py`, `phase0/intelligence/common.py`, `phase0/intelligence/validation.py`, `phase0/intelligence/tiingo_news_probe.py`, `phase0/intelligence/hk_a_mapping_factors.py`, compatibility shims `scripts/tiingo_news_probe.py` and `scripts/export_hk_a_mapping_factors.py`, LLM/integration scripts |
