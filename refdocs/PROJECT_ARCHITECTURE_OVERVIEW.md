...
> 口径来源：`README.md`、`DEVELOPMENT_PLAN.md`、`refdocs/cn_a_share/WEEKLY_EXECUTION_CHECKLIST.md`、`refdocs/cn_a_share/STRATEGY_DEV_CHECKLIST.md`，并结合 `phase0/` 当前代码结构整理。
