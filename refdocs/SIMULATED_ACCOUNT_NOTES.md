...
本文件合并模拟账户设计、账单查询与多账户分类备忘。下方各节保留原文件正文，便于追溯。

## 合并来源

- `refdocs/simulated_account_design_and_bill_query_note.md`
- `refdocs/simulated_account_classification_note.md`

---

## 原文件：`refdocs/simulated_account_design_and_bill_query_note.md`
...
```text
refdocs/SIMULATED_ACCOUNT_NOTES.md
```
...
## 原文件：`refdocs/simulated_account_classification_note.md`
